import 'package:food_application/src/enums/auth_mode.dart';
import 'package:food_application/src/model/user_info.dart';
import 'package:food_application/src/model/user_model.dart';
  ...
  Future<bool> fetchUserInfos() async {
    ...
    try {
      final http.Response response = await http.get(
        Uri.parse('https://flutter-food-a2151.firebaseio.com/users.json'),
      );
    ...
    try {
      ...
      if (authMode == AuthMode.SignUp) {
        response = await http.post(
          Uri.parse(
              'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyAGvoAHizTYT9ztQZ4p1Vgk4sop_wLdYmk'),
        ...
        response = await http.post(
          Uri.parse(
              'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyAGvoAHizTYT9ztQZ4p1Vgk4sop_wLdYmk'),
          body: json.encode(authData),
          headers: {'Content-Type': 'application/json'},
        );
      }
